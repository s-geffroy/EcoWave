...
|:-------------|:----------|:---------|:----------|:--------------|
| UK_SH        | rejected  | rejected | rejected  | rejected      |
| US_SH        | rejected  | rejected | rejected  | rejected      |
| WORLD_SH     | rejected  | rejected | rejected  | rejected      |

## p-values AR(1) (Gate 1 — existence du cycle)

| group_code   |   kitchin |   juglar |   kuznets |   kondratieff |
|:-------------|----------:|---------:|----------:|--------------:|
| UK_SH        |     0.053 |    0.232 |     0.634 |         0.49  |
| US_SH        |     0.089 |    0.078 |     0.565 |         0.743 |
| WORLD_SH     |     0.392 |    0.261 |     0.061 |         0.001 |
...
![Heatmap des phases (consensus)](../figures/cycle_phase_heatmap_2026_05_sh.png)

![Heatmap des amplitudes](../figures/cycle_amplitude_heatmap_2026_05_sh.png)

![Heatmap des p-values (Gate 1)](../figures/cycle_pvalue_heatmap_2026_05_sh.png)

![CF band-pass par cycle](../figures/cycle_cf_trajectories_2026_05_sh.png)

![Spectre wavelet (US_SH)](../figures/cycle_wavelet_power_2026_05_sh.png)
...
- Date de la note : 2026-05-29T12:52:47+00:00
- As-of : 2026-05
